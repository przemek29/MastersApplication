...
class L3G4200D(object):
    ...
    def __init__(self, bus, address, name, fs_scale=FS_500):
        ...
        I2CUtils.i2c_write_byte(self.bus, self.address, L3G4200D.CTRL_REG4,0x20)# ctrl_reg4)

    def read_raw_data(self):
        
        self.gyro_raw_x = I2CUtils.i2c_read_word_signed_l3g4200d(self.bus, self.address, L3G4200D.GYRO_XOUT_H)
        self.gyro_raw_y = I2CUtils.i2c_read_word_signed_l3g4200d(self.bus, self.address, L3G4200D.GYRO_YOUT_H)
        self.gyro_raw_z = I2CUtils.i2c_read_word_signed_l3g4200d(self.bus, self.address, L3G4200D.GYRO_ZOUT_H)
